...
import 'package:siuntu_web_app/utils.dart';
//create hero widget
        ...
        child: ListTile(
          ...
          trailing: Row(
            ...
            children: [
              ...
              if (shipment.shipmentType == 'SELF_SERVICE' && shipment.collected == false)
                new IconButton(
                    onPressed: () {
                      showQRCode(context);
                    },
                    icon: new Icon(Icons.qr_code_outlined)),
              if (shipment.shipmentType == 'SELF_PACK' && shipment.collected == false)
                new IconButton(
                    onPressed: () {
                      createPdf(shipment);
                    },
  ...
  void showMoreInformation(BuildContext context) {
    ...
    Navigator.push(
      ...
      MaterialPageRoute<Widget>(
        ...
        return Scaffold(
            appBar: AppBar(
                title: const Text('Detalesnė informacija')),
            body: Center(
              child: Container(
